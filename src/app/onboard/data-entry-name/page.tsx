          ...
          <Center h="90vh">
            <VStack>
              <Text fontSize="48px" color="White" pb="4rem" fontWeight='400'>
                My name is&nbsp;<Input type="text" value={name} onChange={handleInputChange} placeholder="type here" size="48px" variant="unstyled" fontWeight="600" color="White" width='25rem' _placeholder={{ opacity: 0.4, color: 'inherit' }} />
              </Text>
              <Link
                href={{
